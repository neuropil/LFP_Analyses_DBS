%V4 on 4/4/20; goal is to update this code with the revised helperfx that
%I've recently refined for us with the fx 'AT_CellSummary_SG_IS_io_V4'
...
function [] = lfp_v4(caseNumb, epoch, LFPsource, cutfirst3trials, cutNearOEs, saveFig)
